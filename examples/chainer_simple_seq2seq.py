...
#
# Usage:
#   python examples/chainer_simple_seq2seq.py -m train -c configs/chainer_simple_seq2seq.ini
#   python examples/chainer_simple_seq2seq.py -m eval -c configs/chainer_simple_seq2seq.ini
#
# Purpose:
...
from networks.simple_seq2seq import LSTM_Encoder, LSTM_Decoder, Seq2Seq
